...
<table style="border-collapse: collapse; width: 100%;" border="1" data-ke-align="alignLeft"><tbody><tr><td style="text-align: left;" data-col-size="sm">from</td><td style="text-align: left;" data-col-size="sm">하나의 매개변수를 받아 형변환</td></tr><tr><td style="text-align: left;" data-col-size="sm">of</td><td style="text-align: left;" data-col-size="sm">여러 매개변수를 받아 집계</td></tr><tr><td style="text-align: left;" data-col-size="sm">valueOf</td><td style="text-align: left;" data-col-size="sm">from, of의 더 자세한 버전</td></tr><tr><td style="text-align: left;" data-col-size="sm">instance / getInstance</td><td style="text-align: left;" data-col-size="sm">인스턴스를 반환 (같은 인스턴스일 수도 있음)</td></tr><tr><td style="text-align: left;" data-col-size="sm">create / newInstance</td><td style="text-align: left;" data-col-size="sm">항상 새로운 인스턴스를 생성</td></tr><tr><td style="text-align: left;" data-col-size="sm">getType</td><td style="text-align: left;" data-col-size="sm">다른 클래스에서 타입의 인스턴스를 반환</td></tr><tr><td style="text-align: left;" data-col-size="sm">newType</td><td style="text-align: left;" data-col-size="sm">다른 클래스에서 타입의 새 인스턴스를 반환</td></tr><tr><td style="text-align: left;" data-col-size="sm">type</td><td style="text-align: left;" data-col-size="sm">getType/newType의 간결한 버전</td></tr></tbody></table>
