...
<table style="border-collapse: collapse; width: 100%;" border="1" data-ke-align="alignLeft"><tbody><tr><td data-col-size="sm">커넥션 유지</td><td data-col-size="sm">Step 전체</td><td data-col-size="sm">페이지 조회 시점</td></tr><tr><td data-col-size="sm">DB 세션 점유</td><td data-col-size="sm">장시간</td><td data-col-size="sm">짧음</td></tr><tr><td data-col-size="sm">장애 복구</td><td data-col-size="sm">불안정</td><td data-col-size="sm">안정적</td></tr><tr><td data-col-size="sm">재시작</td><td data-col-size="sm">어렵다</td><td data-col-size="sm">명확하다</td></tr></tbody></table>
